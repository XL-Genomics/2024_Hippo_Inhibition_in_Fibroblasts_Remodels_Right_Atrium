...
sub.srt <- srt[, srt$Cell_type %in% c('EpiC')]
...
sub.srt$tmp[! sub.srt$Cell_type_prev %in% c('EpiC', 'New', 'Doublet')] <- 'Other'
...
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(0)] <- 'EpiC1_RA' 
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(1)] <- 'EpiC2_LA' 
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(2, 3, 4, 5)] <- 'Doublet' 
sub.srt$Cell_state <- factor(sub.srt$Cell_state, levels = c('EpiC1_RA', 'EpiC2_LA', 'Doublet'))
...
dev.off()
####~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~----
saveRDS(sub.srt, 'integrated/PART15.epic_cells.srt.rds')
####~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~----
