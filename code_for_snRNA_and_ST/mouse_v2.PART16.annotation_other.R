...
sub.srt <- srt[, srt$Cell_type %in% c('Mural', 'Schwann', 'Adipo')]
...
####~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
sub.srt <- RunUMAP(sub.srt, reduction = 'mnn', dims = 1:50, min.dist = 1,
...
sub.srt$tmp[! sub.srt$Cell_type_prev %in% c('Mural', 'Schwann', 'Adipo', 'New', 'Doublet')] <- 'Other'
...
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(0)] <- 'Peri' 
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(1)] <- 'Schwann' 
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(2)] <- 'Adipo' 
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(3)] <- 'SMC' 
sub.srt$Cell_state[sub.srt$CBN_snn_res.0.2 %in% c(4)] <- 'Doublet' 
sub.srt$Cell_state <- factor(sub.srt$Cell_state, levels = c('Peri', 'SMC', 'Schwann', 'Adipo', 'Doublet'))
...
dev.off()
####~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~----
saveRDS(sub.srt, 'integrated/PART16.other_cells.srt.rds')
####~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~----
